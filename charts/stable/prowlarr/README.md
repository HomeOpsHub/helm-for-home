...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.31.2.4975](https://img.shields.io/badge/AppVersion-1.31.2.4975-informational?style=flat-square)

A Helm chart for Prowlarr — an indexer manager for Sonarr, Radarr, and other apps
...
Prowlarr is an indexer manager/proxy that integrates with Sonarr, Radarr, Lidarr, Readarr, and other apps. It manages your indexers from a single interface and syncs them automatically to all connected applications. Originally deployed via [ansible-nas](https://github.com/davestephens/ansible-nas), this chart migrates Prowlarr to a Kubernetes-native Helm deployment.

### Features

- Unified indexer management for Usenet and Torrent trackers
- Automatic sync of indexers to Sonarr, Radarr, Lidarr, and Readarr
- Built-in search for manual grabs across all indexers
- Per-app indexer profiles and tag-based filtering
...
| ingress.hosts[0].host | string | `"prowlarr.local"` |  |
