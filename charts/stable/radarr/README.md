...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.16.3.9541](https://img.shields.io/badge/AppVersion-5.16.3.9541-informational?style=flat-square)

A Helm chart for Radarr — a movie collection manager and PVR
...
Radarr is a movie collection manager for Usenet and BitTorrent users. It monitors multiple RSS feeds for new movies and automatically grabs, sorts, and renames them. Originally deployed via [ansible-nas](https://github.com/davestephens/ansible-nas), this chart migrates Radarr to a Kubernetes-native Helm deployment.

### Features

- Automatic movie searching and downloading
- Quality profile management with automatic upgrades
- Failed download handling and retry
- Manual search for fine-grained control
- Integration with popular download clients and indexers
- Flexible media volume support (hostPath, PVC, NFS)
...
| mediaVolumes | list | `[]` | Media volumes for movies and downloads (hostPath, PVC, NFS) |
