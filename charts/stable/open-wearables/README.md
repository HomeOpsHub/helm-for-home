...
![Version: 0.4.0](https://img.shields.io/badge/Version-0.4.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3](https://img.shields.io/badge/AppVersion-0.3-informational?style=flat-square)
...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| backend | object | `{"containerPorts":[{"containerPort":8000,"name":"http","protocol":"TCP"}],"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/atulmgupta/open-wearables-backend","tag":"2cf67f8"},"livenessProbe":{"httpGet":{"path":"/health","port":"http"},"initialDelaySeconds":30,"periodSeconds":10},"readinessProbe":{"httpGet":{"path":"/health","port":"http"},"initialDelaySeconds":15,"periodSeconds":5},"replicaCount":1,"resources":{},"service":{"port":8000,"type":"ClusterIP"}}` | --------------------------------------------------------- |
| beat | object | `{"command":["python","-m","celery","-A","app.celery_app","beat","--loglevel=info"],"enabled":true,"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/atulmgupta/open-wearables-backend","tag":"2cf67f8"},"replicaCount":1,"resources":{}}` | --------------------------------------------------------- |
...
| tolerations | list | `[]` |  |
| worker | object | `{"command":["python","-m","celery","-A","app.celery_app","worker","--loglevel=info"],"enabled":true,"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/atulmgupta/open-wearables-backend","tag":"2cf67f8"},"replicaCount":1,"resources":{}}` | --------------------------------------------------------- |
