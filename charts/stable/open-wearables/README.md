...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3](https://img.shields.io/badge/AppVersion-0.3-informational?style=flat-square)
...
|-----|------|---------|-------------|
| affinity | object | `{}` |  |
| backend | object | `{"containerPorts":[{"containerPort":8000,"name":"http","protocol":"TCP"}],"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/the-momentum/open-wearables-backend","tag":"latest"},"livenessProbe":{"httpGet":{"path":"/health","port":"http"},"initialDelaySeconds":30,"periodSeconds":10},"readinessProbe":{"httpGet":{"path":"/health","port":"http"},"initialDelaySeconds":15,"periodSeconds":5},"replicaCount":1,"resources":{},"service":{"port":8000,"type":"ClusterIP"}}` | --------------------------------------------------------- |
| beat | object | `{"command":["celery","-A","app.celery_app","beat","--loglevel=info"],"enabled":true,"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/the-momentum/open-wearables-backend","tag":"latest"},"replicaCount":1,"resources":{}}` | --------------------------------------------------------- |
...
| frontend | object | `{"containerPorts":[{"containerPort":3000,"name":"http","protocol":"TCP"}],"enabled":true,"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/the-momentum/open-wearables-frontend","tag":"latest"},"livenessProbe":{"httpGet":{"path":"/","port":"http"},"initialDelaySeconds":20,"periodSeconds":10},"readinessProbe":{"httpGet":{"path":"/","port":"http"},"initialDelaySeconds":10,"periodSeconds":5},"replicaCount":1,"resources":{},"service":{"port":3000,"type":"ClusterIP"}}` | --------------------------------------------------------- |
...
| secret | object | `{"data":{},"enabled":false,"type":"Opaque"}` | --------------------------------------------------------- |
| securityContext | object | `{}` |  |
| serviceAccount | object | `{}` |  |
| tolerations | list | `[]` |  |
| worker | object | `{"command":["celery","-A","app.celery_app","worker","--loglevel=info"],"enabled":true,"extraEnv":[],"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/the-momentum/open-wearables-backend","tag":"latest"},"replicaCount":1,"resources":{}}` | --------------------------------------------------------- |
